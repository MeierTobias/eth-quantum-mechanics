...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item The electrons begin to align into opposite directions.     % TODO. The example from Norris. I guess alignment happens per definition due to m_l (or is it spin?)
